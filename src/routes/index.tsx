    ...
    <div className="min-h-screen">
      ...
      <section id="offre" className="mx-auto max-w-7xl px-6 py-24 border-t border-border/40">
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: Gauge, title: t("transferts_haute_performance"), desc: t("virements_p2p_desc") },
            { icon: ShieldCheck, title: t("conformite_edd_integree"), desc: t("verification_renforcee_desc") },
            { icon: Lock, title: t("securite_bancaire_absolue"), desc: t("chiffrement_etc_desc") },
          ].map(({ icon: Icon, title, desc }) => (
            <div key={String(title)} className="p-8 rounded-2xl border border-border bg-surface/50 hover:border-gold transition-all">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl font-semibold tracking-tight mb-4">
              {t("une_infrastructure_conforme")}
              <br/>{t("de_montreal_a_zurich")}
            </h2>
